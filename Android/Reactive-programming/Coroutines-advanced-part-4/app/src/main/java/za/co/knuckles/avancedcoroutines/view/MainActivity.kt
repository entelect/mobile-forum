...
import za.co.knuckles.avancedcoroutines.view_models.ILoveCalculatorViewModel
...
class MainActivity : AppCompatActivity(), IMainView {
    ...
    private fun setupView(){
        calculate.setOnClickListener{
            ...
            this.viewModel.calculateLovePercentage(firstName.text.toString(), secondName.text.toString())
        }
    }
}
